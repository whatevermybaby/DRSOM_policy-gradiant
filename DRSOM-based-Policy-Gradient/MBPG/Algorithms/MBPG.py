...
class MBPG_IM:
    def __init__(self,
        ...
        self.max_path_ength=max_path_length
        self.n_samples=num_train_per_epoch
    ...
    def storm_step(self, grads, old_grads, lr, lr_mutipler=1):
        ...
        params = self._policy.get_parameter_values()

        params = params + lr_mutipler*eta_t * d_p

        params = params - 1e-4 * params

        self._policy.set_parameter_values(params)
    ...
    def train(self, runner):
        ...
        for epoch in runner.step_epochs():
            ...
            paths = runner.obtain_samples(epoch)
            sample_data = self.process_samples(epoch, paths)
            log_performance(epoch,
